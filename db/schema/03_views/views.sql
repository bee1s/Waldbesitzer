  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WG"."V_HOLZERWERB" ("ID", "RE_NUMMER", "RE_DATUM", "ZAHLZIELDAT", "ZAHLZIELTAGE", "RE_TEXT", "RE_UNTERTEXT", "ANREDE", "TITEL", "NAME", "PLZ_ORT", "ORTSTEIL", "STRAS_NUM", "PREIS_ID", "ERWERBART", "MENGE", "BEZEICHNUNG", "PREIS", "GESAMTPREIS", "RE_PREIS", "ERSTELL_DATUM") AS 
  SELECT RK."ID" ,
         RK.ID "RE_NUMMER" ,
 TO_CHAR(RK.RECHNUNGSDATUM, 'DD.MM.YYYY') "RE_DATUM" ,
 TO_CHAR(RK.RECHNUNGSDATUM + 30, 'DD.MM.YYYY') "ZAHLZIELDAT" ,
         RK.ZAHLUNGSZIEL "ZAHLZIELTAGE" ,
         RK.RECHNUNGSTEXT "RE_TEXT" ,
         RK.RECHNUNGSUNTERTEXT "RE_UNTERTEXT" ,         
         AN.ANREDE "ANREDE" ,
         TI.TITEL  "TITEL" ,
         ...
         RP.MENGE "MENGE" ,
         RP.BEZEICHNUNG "BEZEICHNUNG" ,
         HP.FESTMETERPREIS "PREIS" ,
COALESCE(RP.MENGE, 1) * HP.FESTMETERPREIS "GESAMTPREIS" ,
     SUM(COALESCE(RP.MENGE,1) * HP.FESTMETERPREIS) OVER (PARTITION BY RK.ID) "RE_PREIS" ,
